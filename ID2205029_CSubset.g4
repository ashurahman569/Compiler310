grammar ID2205029_CSubset;
import ID2205029_Lexer;
...
parameter_list
    ...
    | parameter_list COMMA type_specifier invalid      #ParamListMultipleGarbage
    | type_specifier ID                                #ParamListSingleID
    | type_specifier                                   #ParamListNoID  
    | type_specifier invalid                           #ParamListGarbage    
    ;
...
declaration_list
    ...
    | ID invalid ID                                           #DeclListGarbage
    | declaration_list COMMA ID invalid ID                    #MultipleDeclListGarbage
    ;
...
statement
    ...
    | PRINTLN LPAREN ID RPAREN SEMICOLON     #PrintLineStatement
...
simple_expression
    ...
    | simple_expression ADDOP invalid                #SimpleAddInvalidTerm
    ;
